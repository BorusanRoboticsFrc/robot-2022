...
import frc.robot.commands.Climb.LeftClimb;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    // SIMULATION
    m_robotDrive.setDefaultCommand(new JoystickDriveCommand(m_robotDrive,() -> -m_driverController.getRawAxis(1),() -> m_driverController.getRawAxis(0)));
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, 2).whileHeld(new AutoShootCommand());

    // Sol Tırmanma
    new JoystickButton(m_driverController, 7).whileHeld(new LeftClimb(m_climb,1));
    new JoystickButton(m_driverController, 8).whileHeld(new LeftClimb(m_climb,-1));

    // Sağ Tırmanma
    new JoystickButton(m_driverController, 9).whileHeld(new LeftClimb(m_climb,1));
    new JoystickButton(m_driverController, 10).whileHeld(new LeftClimb(m_climb,-1));
