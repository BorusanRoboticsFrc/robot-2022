...
public class Robot extends TimedRobot {
  ...
  NetworkTable table = photon.getTable("borusanphotonvision").getSubTable("borusanvision");
  ...
  public void robotInit() {
    ...
    photon.startClient("10.49.72.12");
    ...
    SmartDashboard.putNumber("toplam akım", getTotalCurrent());
    SmartDashboard.putNumber("toplam güç", getTotalPower());
    SmartDashboard.putNumber("toplam enerji", getTotalEnergy());
    SmartDashboard.putNumber("sıcaklık", getTemperature());
    SmartDashboard.putNumber("shooter akım", getVictorShooter());
    SmartDashboard.putNumber("turret akım", getVictorTurret());
    SmartDashboard.putNumber("funnel akım", getVictorFunnel());
    SmartDashboard.putNumber("intake akım", getVictorIntake());
    SmartDashboard.putNumber("climb2 akım", getVictorClimb2());
    SmartDashboard.putNumber("climb1 akım", getVictorClimb());
